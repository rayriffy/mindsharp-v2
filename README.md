[![CircleCI](https://circleci.com/gh/rayriffy/mindsharp-v2.svg?style=svg)](https://circleci.com/gh/rayriffy/mindsharp-v2)

# Mindsharp Story
the new face of Mindsharp Story
...
## Installing
 ...
 Install LEMP stack to your server. I recommended to use `nginx` [Installing Guide](https://www.digitalocean.com/community/tutorials/how-to-install-linux-nginx-mysql-php-lemp-stack-in-ubuntu-16-04). Clone everything to domain root directory and ...done
...
---|---|---|---|---|---|---
45+|44+|32+|Based on Chromium 44.2403+|17+|11.1+|Go away REEEEEE
